package com.bodybody.firebase.chat.activities.constants;

import java.io.File;

public interface IConstants {
    // ads_shown 변수는 이제 build.gradle 파일로 이동했습니다. I 참고
    ...
    // 여기에서 개인 이미지 미리보기를 구성 할 수 있습니다. 필요에 따라 자유롭게 수정할 수 있습니다.
