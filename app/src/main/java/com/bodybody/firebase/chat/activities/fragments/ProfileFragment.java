...
import static com.bodybody.firebase.chat.activities.constants.IConstants.EXTRA_ABOUT;
import static com.bodybody.firebase.chat.activities.constants.IConstants.EXTRA_ADMIN;
import static com.bodybody.firebase.chat.activities.constants.IConstants.EXTRA_GROUPS_IN;
import static com.bodybody.firebase.chat.activities.constants.IConstants.EXTRA_GROUPS_IN_BOTH;
import static com.bodybody.firebase.chat.activities.constants.IConstants.EXTRA_GROUP_MEMBERS;
...
import static com.bodybody.firebase.chat.activities.constants.IConstants.REF_GROUP_MEMBERS;
...
import static com.bodybody.firebase.chat.activities.constants.IConstants.REF_UPLOAD;
...
import static com.bodybody.firebase.chat.activities.constants.IConstants.TYPE_GOOGLE;
...
//프로필 프레그먼트는 베이스 프레그먼트를 상속 받습니다.
//사용자 프로필 이미지, 이름, 성별, 소개글, 이메일, 비밀번호, 토큰 등의 내용들을 담습니다.
//유저 목록, 그룹 관리자 목록. 그룹 관리자 멤버 목록, 기타 목록 등에 관여합니다.
public class ProfileFragment extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        //초기에 보여지는 상태 메세지와 성별을 지정하지 않았을때 뜨는 문구, 성별 등이 보여집니다.
