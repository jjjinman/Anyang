...
import static com.bodybody.firebase.chat.activities.constants.IConstants.IMG_PREVIEW;
...
//뷰 유저 프로필 프레그먼트는 베이스 프레그먼트를 상속받습니다.
//동그란 원 안에 보여지는 아바타 이미지, 성별, 설명, 뷰 유저 id, 유저 이름 등을 받습니다.
