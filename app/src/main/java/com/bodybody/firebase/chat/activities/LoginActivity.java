...
import static com.bodybody.firebase.chat.activities.constants.IConstants.EXTRA_SOCIAL_TOKEN;
...
//로그인 액티비티 클래스는 베이스 액티비티를 상속받습니다.
//이메일과 비밀번호 또는, 구글 계정으로 로그인 할 수 있습니다.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                    ...
                    //Firebase를 통해 구글 로그인 기능을 구현하는 과정에서 default_web_client_id가
                    //문자열 리소스가 존재하지 않아 오류가 떠 빨간색으로 표시되었습니다.
                    //이후 안드로이드 스튜디오의 프로젝트 창 보기를 project로 전환 후 google-service.json
                    //파일을 넣어주고 Build -> Clean Project 후 Rebuild Project를 클릭해주었습니다.
                    //이로써 google-service -> values에 values.xml파일이 생겼습니다.
                    //이 파일엔 default_web_client_id라는 문자열 리소스를 갖기 때문에 해당 오류가 사라집니다.
                    .requestEmail()
                    .build();
