...
import com.bodybody.firebase.chat.activities.fragments.ChatsFragment;
import com.bodybody.firebase.chat.activities.fragments.GroupsFragment;
import com.bodybody.firebase.chat.activities.fragments.ProfileFragment;
import com.bodybody.firebase.chat.activities.managers.Utils;
import com.bodybody.firebase.chat.activities.models.User;
import com.bodybody.firebase.chat.activities.views.CustomTypefaceSpan;
...
//메인 액티비티 클래스는 베이스 액티비티를 상속받습니다.
//사용자 이름과 프로필 이미지, mViewPager 등을 사용합니다.
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 바디바디 채팅을 시작할때 보여지는 메인 페이지로 뷰 페이저를 사용해 타입 별로 나누었습니다.
        // 1:1 채팅을 할 수 있는 채팅과 그룹채팅, 프로필 등으로 구성되어 있습니다.
